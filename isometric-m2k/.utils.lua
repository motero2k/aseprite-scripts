function cubeMapper(isoCube, func)
    local mappedCube = {}
    mappedCube.top = TableMapper(isoCube.top, func)
    mappedCube.left = TableMapper(isoCube.left, func)
    mappedCube.right = TableMapper(isoCube.right, func)
    mappedCube.full = TableMapper(isoCube.full, func)
    return mappedCube
end
